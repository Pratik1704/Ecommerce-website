        ...
        <?php 
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                <div class="card" style="width: 18rem;">
                    <img src="https://source.unsplash.com/2400x1200/?'.$product_name.'" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">'.$product_name.'</h5>
                        <p class="card-text">'.$product_description.'</p>
                        <p>Price : '.$product_price.'</p>
                        <a href="product.php?productid='.$product_id.'" class="btn btn-primary">'.$product_name.'</a>
                    </div>
                </div>
            </div>';
